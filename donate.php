...
<ul class="dropdown">
  ...
  <section>
                        <div class="about_col_left">
                            <img src="images/prisoners.jpg"  width="500" height="400"/>
                        </div>
                        <div class="about_col_right">
                            <h2>1. Donate Money</h2>

                            <p>Your money will help us run more transformative programs in prisons and 
                                communities targeting prisoners, ex-offenders and at-risk youth.</p>

                            <h2>2. Donate Stuff</h2>

                            <p>It is not always about money. We work in very vulnerable and impoverished
                                communities, so we can put to effective use any of the clutter that is taking
                                up space in your homes, such as: sporting equipment, musical instruments,
                                educational material, books (adults and children), gardening equipment,
                                furniture (chairs, tables, carpets, beds, electronic equipment, toys, clothing
                                and linen. If you have something you'd be able to give, please drop us a line
                                at info@brothersforall.org.</p> 

                            <h2>3. Donate Time</h2>

                            <p>If you have time to give, there are several ways you can help us - especially if
                                you can be a coding mentor! If you're interested, we'd love to hear from you
                                at info@brothersforall.org.</p> 
